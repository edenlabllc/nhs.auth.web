...
export const API_ENDPOINT = config.API_ENDPOINT || process.env.API_ENDPOINT || 'http://35.187.186.145';
export const AUTH_ENDPOINT = config.API_ENDPOINT || process.env.AUTH_ENDPOINT || 'http://35.187.186.145';
