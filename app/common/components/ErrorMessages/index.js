  ...
  render() {
    ...
    return (
      <ErrorMessages {...rest}>
        ...
        <ErrorMessage when="passwordMismatch">
          Не вірно введено пароль
        </ErrorMessage>
        ...
        <ErrorMessage when="accountPasswordMismatch">
          {t("Account or password combination mismatch")}
        </ErrorMessage>
        ...
        <ErrorMessage when="reached_max_attempts">
          Ви досягнули максимальної кількості спроб авторизації. Спробуйте
          пізніше
        </ErrorMessage>
