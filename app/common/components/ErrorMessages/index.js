  ...
  render() {
    ...
    return (
      <ErrorMessages {...rest}>
        ...
        <ErrorMessage when="emailOrPasswordMismatch">{t('Account or password combination mismatch')}</ErrorMessage>
        ...
        <ErrorMessage when="reached_max_attemps">
          Ви досягнули максимальної кількості спроб. Спробуйте пізніше
        </ErrorMessage>
      </ErrorMessages>
    );
  }
